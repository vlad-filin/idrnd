...
keker = Keker(model=model,
              ...
              callbacks=[ScoreCallback('preds', 'label', compute_err,
                                       'checkpoints/2branch_NTE_addData45',
                                       logdir='tensorboard/2branch_NTE_addData45')],
...
with autograd.detect_anomaly():
    keker.kek(lr=1e-3,
             ...
             cp_saver_params={
                  "savedir": "checkpoints/2branch_NTE_addData45",
             "metric":"acc",
             "mode":'max'},
              logdir="tensorboard/2branch_NTE_addData45")


torch.save(model.state_dict(), "checkpoints/2branch_NTE_addData45/final.pt")